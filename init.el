...
(custom-set-variables
 ...
 '(package-selected-packages
   '(haki-theme treesit typescript-ts-base-mode tsx-ts-mode yaml-mode xclip web-mode vterm use-package tagedit smudge projectile prettier-js paredit org-gcal org-bullets magit lua-mode lsp-ui lsp-treemacs lsp-ivy ivy-prescient guru-mode flycheck doom-themes doom-modeline doct dashboard counsel company-prescient cider all-the-icons add-node-modules-path ace-jump-mode))
