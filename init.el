...
(custom-set-variables
 ...
 '(package-selected-packages
   '(solarized-theme xclip ivy-prescient counsel magit tagedit elpy prettier-js web-mode projectile cider flycheck-clj-kondo clojure-mode-extra-font-locking clojure-mode flycheck paredit)))
...
(custom-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "snow" :slant normal :weight bold))))
 '(font-lock-keyword-face ((t (:foreground "chartreuse" :weight bold))))
