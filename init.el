...
(custom-set-variables
 ...
 '(package-selected-packages
   '(solarized-theme xclip magit tagedit elpy prettier-js web-mode projectile smex cider flycheck-clj-kondo clojure-mode-extra-font-locking clojure-mode flycheck paredit)))
