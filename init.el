...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cypher-mode spacemacs-theme xclip yaml-mode company-prescient ivy-prescient counsel magit tagedit elpy prettier-js web-mode projectile cider flycheck-clj-kondo clojure-mode-extra-font-locking clojure-mode flycheck paredit)))
